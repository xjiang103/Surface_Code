...
def fun_sp(params):
    ...
    res = qutip_phase([0.78051999,0.08161766,0.08144444,0.08126569] ,dm)
...
def qutip_phase(params,dm):
    ...
    state = tensor(basis(2,1),basis(2,1),basis(2,1),basis(2,1))
...
default_sp_params = [17.34728195,0.77401015,200]
