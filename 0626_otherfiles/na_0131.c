...
PetscErrorCode ts_monitor(TS ts,PetscInt step,PetscReal time,Vec rho_data,void *ctx){
  ...
  get_expectation_value_qvec(dm_dummy,&trace_val2,8,atoms[0][one],atoms[0][one],atoms[1][one],atoms[1][one],atoms[2][one],atoms[2][one],atoms[3][zero],atoms[3][zero]);
  get_expectation_value_qvec(dm_dummy,&trace_val3,8,atoms[0][one],atoms[0][one],atoms[1][one],atoms[1][one],atoms[2][zero],atoms[2][zero],atoms[3][zero],atoms[3][zero]);
