...
PetscErrorCode ts_monitor(TS ts,PetscInt step,PetscReal time,Vec rho_data,void *ctx){
  ...
  PetscScalar trace_val,trace_val2,trace_val3,trace_val4,trace_val5,trace_val6,trace_val7,trace_val8,ph_val1,ph_val2,ph_val3;
  Vec tmp_data;
  enum STATE {zero=0,one,r};
  ...
  get_wf_element_qvec(dm_dummy,9,&ph_val1);
  get_wf_element_qvec(dm_dummy,12,&ph_val2);
  get_wf_element_qvec(dm_dummy,13,&ph_val3);
  ...
  PetscFPrintf(PETSC_COMM_WORLD,data_fp,"%d %f %f %f %f %f %f %f %f %f %f %f %f\n",step,time,
  PetscRealPart(trace_val),PetscRealPart(trace_val2),PetscRealPart(trace_val3),PetscRealPart(trace_val4),PetscRealPart(trace_val5),PetscRealPart(trace_val6),PetscRealPart(trace_val7),PetscRealPart(trace_val8),
  PetscArgComplex(ph_val1),PetscArgComplex(ph_val2),PetscArgComplex(ph_val3));
