...
int main(int argc,char **args){
  ...
  add_ham_term(qsys,b_field*0,4,atoms[1][r],atoms[1][r],atoms[2][r],atoms[2][r]);
  //Add lindblad terms
  for(i=0;i<n_atoms;i++){
...
PetscErrorCode ts_monitor(TS ts,PetscInt step,PetscReal time,Vec rho_data,void *ctx){
  ...
  get_expectation_value_qvec(pulse_params->dm_dummy,&trace_val,6,pulse_params->atoms[0][one],pulse_params->atoms[0][one],pulse_params->atoms[1][zero],pulse_params->atoms[1][zero],pulse_params->atoms[2][zero],pulse_params->atoms[2][zero]);
  get_expectation_value_qvec(pulse_params->dm_dummy,&trace_val2,6,pulse_params->atoms[0][r],pulse_params->atoms[0][r],pulse_params->atoms[1][zero],pulse_params->atoms[1][zero],pulse_params->atoms[1][zero],pulse_params->atoms[1][zero]);
  get_expectation_value_qvec(pulse_params->dm_dummy,&trace_val3,6,pulse_params->atoms[0][d],pulse_params->atoms[0][d],,pulse_params->atoms[1][zero],pulse_params->atoms[1][zero],pulse_params->atoms[1][zero],pulse_params->atoms[1][zero]);
