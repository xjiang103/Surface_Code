...
int main(int argc,char *args[]){
  ...
  PetscScalar tmp_scalar = 1.0,b_term=200,b_dr,b_0r,b_1r,gamma_r,valpar,diagsum,meas_val,gamma_t1,gamma_t2s;
  ...
  char bitstr[PETSC_MAX_PATH_LEN] = "1100"; //Default bitstr to start with
  ...
  add_ham_term(qsys,0*b_term,4,atoms[1][r],atoms[1][r],atoms[2][r],atoms[2][r]);
  add_ham_term(qsys,0*b_term,4,atoms[1][r],atoms[1][r],atoms[3][r],atoms[3][r]);
  add_ham_term(qsys,0*b_term,4,atoms[2][r],atoms[2][r],atoms[3][r],atoms[3][r]);
...
PetscErrorCode ts_monitor(TS ts,PetscInt step,PetscReal time,Vec rho_data,void *ctx){
  ...
  PetscScalar trace_val,trace_val2,trace_val3,trace_val4,trace_val5,trace_val6,trace_val7,trace_val8,ph_val1,ph_val2,ph_val3,ph_val4,ph_val5;
  Vec tmp_data;
  enum STATE {zero=0,one,r};
  ...
  get_expectation_value_qvec(dm_dummy,&trace_val2,8,atoms[0][r],atoms[0][r],atoms[1][one],atoms[1][one],atoms[2][one],atoms[2][one],atoms[3][one],atoms[3][one]);
  get_expectation_value_qvec(dm_dummy,&trace_val3,8,atoms[0][one],atoms[0][r],atoms[1][r],atoms[1][one],atoms[2][one],atoms[2][one],atoms[3][one],atoms[3][one]);
  get_expectation_value_qvec(dm_dummy,&trace_val4,8,atoms[0][r],atoms[0][r],atoms[1][r],atoms[1][r],atoms[2][one],atoms[2][one],atoms[3][one],atoms[3][one]);
  get_expectation_value_qvec(dm_dummy,&trace_val5,8,atoms[0][one],atoms[0][one],atoms[1][r],atoms[1][r],atoms[2][r],atoms[2][r],atoms[3][one],atoms[3][one]);
  get_expectation_value_qvec(dm_dummy,&trace_val6,8,atoms[0][r],atoms[0][r],atoms[1][r],atoms[1][r],atoms[2][r],atoms[2][r],atoms[3][one],atoms[3][one]);        
  get_expectation_value_qvec(dm_dummy,&trace_val7,8,atoms[0][one],atoms[0][one],atoms[1][r],atoms[1][r],atoms[2][r],atoms[2][r],atoms[3][r],atoms[3][r]);
  
  get_wf_element_qvec(dm_dummy,40,&ph_val1);
  get_wf_element_qvec(dm_dummy,39,&ph_val2);
  get_wf_element_qvec(dm_dummy,36,&ph_val3);
  get_wf_element_qvec(dm_dummy,17,&ph_val4);
  get_wf_element_qvec(dm_dummy,26,&ph_val5);
  
  //ph_val1=1+1*PETSC_i;
  
  PetscFPrintf(PETSC_COMM_WORLD,data_fp,"%d %f %f %f %f %f %f %f %f %f %f %f %f %f %f\n",step,time,
  PetscRealPart(trace_val),PetscRealPart(trace_val2),PetscRealPart(trace_val3),PetscRealPart(trace_val4),PetscRealPart(trace_val5),PetscRealPart(trace_val6),PetscRealPart(trace_val7),
  PetscArgComplex(ph_val1),PetscArgComplex(ph_val2),PetscArgComplex(ph_val3),PetscArgComplex(ph_val4),PetscArgComplex(ph_val5));
