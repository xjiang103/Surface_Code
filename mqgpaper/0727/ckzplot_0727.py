...
plt.plot(barr,farr,'o-',color='red',label="2_wm")
farr=[val[1] for val in contentold2]
plt.plot(barr,farr,'--',color='red',label="2_am")

barr=[val[0] for val in content3]
farr=[val[1] for val in content3]
plt.plot(barr,farr,'o-',color='blue',label="3_wm")
farr=[val[1] for val in contentold3]
plt.plot(barr,farr,'--',color='blue',label="3_am")

barr=[val[0] for val in content4]
farr=[val[1] for val in content4]
plt.plot(barr,farr,'o-',color='green',label="4_wm")
farr=[val[1] for val in contentold4]
plt.plot(barr,farr,'--',color='green',label="4_am")

plt.legend(loc='lower right', prop={'size': 8})
plt.xlabel("Β/2π (MHz)")
plt.ylabel("Fidelity")

filestr='fidplot_0727.png'
