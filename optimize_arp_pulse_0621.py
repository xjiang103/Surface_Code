...
def fun_sp(params,final_run=None):
    ...
    #Run QuaC
    try:
        output = subprocess.check_output(["./na_4_par_0621","-ts_rk_type","5bs","-ts_rtol","1e-8","-ts_atol","1e-8","-n_ens","-1",
...
print("Optimizing ARP for bj = ",str(bj))
print("Optimizing ARP for bk = ",str(bk))
f.write(str(ddfac)+' ')
#f.write(str(b)+' ')
