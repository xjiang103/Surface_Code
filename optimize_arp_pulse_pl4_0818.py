...
f=open("op_4_arp_par_0818.txt","a")
f.write('\n')
f.write(typestr+' ')
def fun_sp(params,final_run=None):
    ...
    #Run QuaC
    try:
        output = subprocess.check_output(["./na_4_par_3lvl2_0809","-ts_rk_type","5bs","-ts_rtol","1e-8","-ts_atol","1e-8","-n_ens","-1",
...
print("Optimizing ARP for db = ",str(deltab))
