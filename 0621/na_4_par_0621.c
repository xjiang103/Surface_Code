...
int main(int argc,char *args[]){
  ...
  PetscScalar tmp_scalar = 1.0,b_term=600,b_dr,b_0r,b_1r,gamma_r,valpar,diagsum,meas_val,gamma_t1,gamma_t2s,b_j,b_k;
  ...
  PetscOptionsGetReal(NULL,NULL,"-b_j",&b_j,NULL);
  PetscOptionsGetReal(NULL,NULL,"-b_k",&b_k,NULL);
  ...
  add_ham_term(qsys,b_j,4,atoms[0][r],atoms[0][r],atoms[1][r],atoms[1][r]);
  add_ham_term(qsys,b_k,4,atoms[0][r],atoms[0][r],atoms[2][r],atoms[2][r]);
  add_ham_term(qsys,b_j,4,atoms[0][r],atoms[0][r],atoms[3][r],atoms[3][r]);
  add_ham_term(qsys,b_j,4,atoms[1][r],atoms[1][r],atoms[2][r],atoms[2][r]);
  add_ham_term(qsys,b_k,4,atoms[1][r],atoms[1][r],atoms[3][r],atoms[3][r]);
  add_ham_term(qsys,b_j,4,atoms[2][r],atoms[2][r],atoms[3][r],atoms[3][r]);
