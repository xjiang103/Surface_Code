...
//add_ham_term(qsys,tmp_scalar,2,atoms[seqgroup[i][j]][r],atoms[seqgroup[i][j]][one]);
  ...
  add_ham_term(qsys,dd_fac+0*deltab,4,atoms[1][r],atoms[1][r],atoms[2][r],atoms[2][r]);
  add_ham_term(qsys,dd_fac-1*deltab,4,atoms[1][r],atoms[1][r],atoms[3][r],atoms[3][r]);
  add_ham_term(qsys,dd_fac-2*deltab,4,atoms[2][r],atoms[2][r],atoms[3][r],atoms[3][r]);
