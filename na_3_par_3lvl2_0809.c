...
int main(int argc,char *args[]){
  ...
  PetscScalar tmp_scalar = 1.0,b_term=200,deltab=0,b_dr,b_0r,b_1r,gamma_r,valpar,diagsum,meas_val,gamma_t1,gamma_t2s;
  ...
  printf("b= %f\n",b_term);
  printf("deltab= %f\n",deltab);
  add_ham_term(qsys,b_term+deltab,4,atoms[0][r],atoms[0][r],atoms[1][r],atoms[1][r]);
  add_ham_term(qsys,b_term-deltab,4,atoms[0][r],atoms[0][r],atoms[2][r],atoms[2][r]);
  add_ham_term(qsys,b_term,4,atoms[1][r],atoms[1][r],atoms[2][r],atoms[2][r]);
